...
var policegroup
var fullgamestate=1;
var start,gunsound,policesound,reload,wallpaper,ending;
var heliedestroy=0
var wingame="none"
...
text("BULLET RAMPAGE",displayWidth/3,50)
    ...
    text("• The player has three lives and they can be lost if the car or the police car or the bullets from the helicopter",50,displayHeight/2+100);
  
    text("• You can shoot the police car or the people going on the road or the helicopter and also the police",50,displayHeight/2+60)
  
    text(" get destroyed when hit two times and three times respectively",50,displayHeight/2+140);
    start.mousePressed
    (
      function()
      {
...
function gameMain()
{
  ...
  if((heli!==undefined)&&(heli.lifetime>0)&&frameCount%80===0)
  {
    ...
    helibullet.lifetime=innerWidth/7;
